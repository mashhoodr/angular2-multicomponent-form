  ...
  getFormFields() {
    return [{
      ...
      fields: [
        ...
        new TextFormField('input_age_user', 'Age', '', '', new Validator('custom', 'age must be between (min: 1 and max: 150)', ['^([1-9]|[1-9][0-9]|[1-9][0-5][0])$']))
      ]
    },
    {
      section: 'step2',
      fields: [
        ...
        new TextFormField('input_dependants', 'Number of Dependants', '', '', new Validator('custom', 'must be between 0 - 9', ['^(0?[1-9])$']))
      ]
    }];
  }
